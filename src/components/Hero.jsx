    ...
    >
      ...
      <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-12 z-10" id='hero'>
        <a
          ...
          className="flex flex-row items-center justify-center gap-x-2 rounded-lg text-white px-10 py-3 bg-blue-500 hover:bg-blue-600 transition-colors duration-200"
        >
          <svg
        ...
        <a
          href="#demo"
          className="flex flex-row items-center justify-center gap-x-2 rounded-lg border border-blue-500 px-10 py-3 text-blue-500 hover:bg-blue-500 hover:text-white transition-colors duration-200"
        >
          Learn More →
        </a>
      </div>
